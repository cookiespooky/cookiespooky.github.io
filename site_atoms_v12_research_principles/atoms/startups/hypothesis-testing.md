...
kind: method
hub: methods
summary: Быстрая проверка предположений о клиенте, проблеме, ценности, канале или
  продукте.
status: public
links:
- id: mvp
...
seo:
  title: Проверка гипотез
  description: Быстрая проверка предположений о клиенте, проблеме, ценности, канале
    или продукте.
---
...
Связанные элементы графа: [[mvp|MVP]], [[product-thinking|Product thinking]], [[offer|Оффер]], [[system-before-sales|Система вместо продаж]], [[lead-product-choice|Выбор главного продукта]].
