...
actions:
  - label: "Сформулировать гипотезу"
    ...
    help: "Поможет превратить расплывчатую идею в проверяемое утверждение."
  - label: "Выбрать аудиторию"
    target: "icp"
    help: "Поможет понять, у кого проверять гипотезу."
  - label: "Проверить спрос"
    target: "demand-validation"
    help: "Поможет выбрать первый тест."
seo:
  title: "Стартап-гипотеза"
