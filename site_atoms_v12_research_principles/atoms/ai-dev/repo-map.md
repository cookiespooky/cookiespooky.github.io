...
kind: artifact
hub: tools
summary: 'Карта репозитория — краткое описание структуры проекта: папки, ключевые
  файлы, точки входа, зависимости и места, которые нельзя менять без причины.'
status: public
links:
- id: context-package
  rel: part_of
...
- label: Собрать карту проекта
  ...
  help: Поможет начать разработку с понимания структуры, а не с шаманского поиска
    файла app2_final_REAL.js.
---
