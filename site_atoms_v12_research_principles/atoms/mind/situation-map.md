...
- label: Построить карту моей ситуации
  target: lead-cognitive-reconstruction
  help: Поможет собрать элементы ситуации в структуру и увидеть следующий шаг.
- label: Посмотреть граф ситуации
  target: situation-graph
  help: Поможет понять визуальный формат карты.
seo:
  title: Карта ситуации
...
Карта ситуации — структурное описание сложного контекста. В ней фиксируются элементы, связи, повторяющиеся сценарии, пустоты и возможные точки действия.
