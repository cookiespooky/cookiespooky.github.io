...
seo:
  title: Повторяющиеся сценарии
  description: Устойчивые паттерны решений, реакций и действий, которые повторяются в разных
    ситуациях.
---

# Повторяющиеся сценарии

Повторяющийся сценарий — устойчивая последовательность реакций, объяснений и действий, которая проявляется в разных ситуациях.
