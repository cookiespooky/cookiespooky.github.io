...
kind: action
hub: products
summary: Практический формат работы, в котором ситуация разбирается через диалог,
  заметки, атомизацию и построение карты.
status: public
links:
...
seo:
  title: Сессия разбора ситуации
  description: Практический формат работы, в котором ситуация разбирается через диалог,
    заметки, атомизацию и построение карты.
---
