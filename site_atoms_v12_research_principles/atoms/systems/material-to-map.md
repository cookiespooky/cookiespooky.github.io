...
kind: scenario
hub: methods
summary: Сценарий работы, в котором исходные заметки или описания превращаются в атомы,
  связи, карту ситуации и точки действия.
status: public
links:
- id: source-material
  rel: starts_from
...
seo:
  title: От материала к карте
  description: Сценарий работы, в котором исходные заметки или описания превращаются
    в атомы, связи, карту ситуации и точки действия.
---
