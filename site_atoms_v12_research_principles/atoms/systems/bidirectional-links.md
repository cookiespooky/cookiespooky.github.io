...
kind: concept
hub: tools
summary: Связи между заметками, которые позволяют видеть не только исходящую ссылку,
  но и обратные контексты упоминания.
status: public
links:
- id: wikilinks
  rel: uses
...
seo:
  title: Двусторонние связи
  description: Связи между заметками, которые позволяют видеть не только исходящую
    ссылку, но и обратные контексты упоминания.
---
