...
kind: method
hub: tools
summary: Процесс превращения личных заметок в публичные атомы, связанные страницы,
  маршруты пользователя и материал для модели.
status: public
links:
- id: obsidian
  rel: starts_from
...
seo:
  title: Пайплайн заметки → сайт
  description: Процесс превращения личных заметок в публичные атомы, связанные страницы,
    маршруты пользователя и материал для модели.
---
