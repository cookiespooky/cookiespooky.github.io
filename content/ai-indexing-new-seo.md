...
title: "ИИ-индексация и SEO: почему сайт из заметок должен быть структурой знаний"
description: Почему классическое SEO меняется в эпоху AI-поиска и как Notepub помогает публиковать знания так, чтобы их было легче понимать людям и моделям.
draft: false
noindex: false
legacy_from_old_site: true
---

# ИИ-индексация и SEO: почему сайт из заметок должен быть структурой знаний

> Эта страница сохранена на старом индексируемом slug и обновлена под текущую архитектуру сайта. Она связывает тему AI-поиска с Notepub, Markdown-графом и структурой знаний.

Почему классическая оптимизация устаревает и почему [[notepub|Notepub]] идеально подходит под новую реальность
...
[[notepub|Notepub]] был задуман как платформа для публикации знаний, а не еще один конструктор сайтов. Парадоксально, но именно это делает его идеальным решением для новой эпохи ИИ-поиска.

Вот почему Notepub - лучший формат для ИИ-индексации:
### Плоская структура URL - идеальный доступ для ИИ моделей

В [[notepub|Notepub]] каждая заметка доступна по прямому URL без вложенности и сложных путей вида:
...
Каждый документ [[notepub|Notepub]] содержит фронтматтер:
...
[[notepub|Notepub]] обеспечивает автоматическую публикацию изменений из Obsidian, гибкость структуры заметок без потери URL, SEO-сигнал "страница актуальна" без перестройки сайта.
...
Категории во фронтматтере [[notepub|Notepub]] как раз создают такой остров:
...
[[notepub|Notepub]] случайно оказался идеальным решением именно под эту эпоху. Он создавался как инструмент для публикации личных знаний, но стал лучшей платформой для ИИ-индексации.

## Что делать дальше

Если у вас уже есть Obsidian, Markdown-архив или база заметок, начните со страницы [[from-notes-to-website|как превратить заметки в сайт]] или с оффера [[notepub-offer|сайт из заметок]].
