...
- [[ai-development|AI-разработка]] — related_to
- [[llm-site|LLM-сайт]] — related_to
- [[ai-agents|AI-агенты]] — related_to
- [[knowledge-graph|Граф знаний]] — compatible_with
- [[lead-ai-development|AI-разработка проекта]] — leads_to

## Следующие действия

- **Посмотреть интерфейсы без чата** → [[ai-development|AI-разработка]]: Поможет уточнить контекст и перейти к следующему связанному понятию.
- **Связать с сайтом** → [[ai-development|AI-разработка]]: Поможет уточнить контекст и перейти к следующему связанному понятию.
- **Понять архитектуру** → [[ai-development|AI-разработка]]: Поможет уточнить контекст и перейти к следующему связанному понятию.
- **Обсудить AI-проект** → [[lead-ai-development|AI-разработка проекта]]: Поможет определить MVP, сценарий разработки и роль модели в продукте.
