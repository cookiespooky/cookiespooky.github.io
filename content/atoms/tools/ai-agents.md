...
- [[prompt-engineering|Промпт-инжиниринг]] — uses
- [[llm-apps|LLM-приложения]] — related_to

## Следующие действия

- **Понять сценарии агентов** → [[ai-development|AI-разработка]]: Поможет уточнить контекст и перейти к следующему связанному понятию.
- **Связать с автоматизацией** → [[ai-development|AI-разработка]]: Поможет уточнить контекст и перейти к следующему связанному понятию.
- **Посмотреть ограничения** → [[ai-development|AI-разработка]]: Поможет уточнить контекст и перейти к следующему связанному понятию.
