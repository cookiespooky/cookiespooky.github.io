...
Связанные элементы графа: [[language-markers]], [[agency]], [[cognitive-reconstruction]], [[causality]], [[world-model]], [[cognitive-gaps]], [[analysis-lens]].
...
- [[analysis-lens]] — example_of

## Следующие действия

- **Показать языковые маркеры** → [[language-markers]]: Поможет уточнить контекст и перейти к следующему связанному понятию.
...
- **Разобрать фразу** → [[language-markers]]: Поможет уточнить контекст и перейти к следующему связанному понятию.
- **Посмотреть LAT как линзу** → [[analysis-lens]]: Поможет понять, как языковой анализ становится рамкой чтения ситуации.
