...
Связанные элементы графа: [[icp|ICP]], [[offer|Оффер]], [[content-to-leads|Контент в заявки]], [[code-word-cta|Кодовое слово в комментариях]], [[comment-to-dm-flow|Переход из комментария в личку]].

## Связи

- [[icp|ICP]] — uses
- [[offer|Оффер]] — leads_to
- [[content-to-leads|Контент в заявки]] — part_of
- [[code-word-cta|Кодовое слово в комментариях]] — compatible_with
- [[comment-to-dm-flow|Переход из комментария в личку]] — leads_to

## Следующие действия

- **Уточнить аудиторию** → [[icp|ICP]]: Поможет написать пост не для всех, а для конкретного человека с конкретной ситуацией.
- **Связать с действием** → [[code-word-cta|Кодовое слово в комментариях]]: Поможет сделать следующий шаг простым и неагрессивным.
- **Проверить посты** → [[lead-content-map|Собрать карту контента и заявок]]: Поможет найти темы, которые могут давать заявки.
