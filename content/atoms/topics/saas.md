...
- **Проверить SaaS-идею** → [[mvp|MVP]]: Поможет уточнить контекст и перейти к следующему связанному понятию.
- **Связать с MVP** → [[lead-ai-development|AI-разработка проекта]]: Поможет быстро перейти от идеи к рабочему прототипу или понятному техническому плану.
- **Посмотреть риски** → [[mvp|MVP]]: Поможет уточнить контекст и перейти к следующему связанному понятию.


## Дополнение: стартап-маршрут

Для SaaS-маршрута добавлены связи с [[demand-validation|Проверка спроса]], [[product-market-fit|Product market fit]] и [[build-trap|Ловушка разработки]].
