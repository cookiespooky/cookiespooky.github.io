...
Связи: [[archetypes]], [[research]], [[world-model]], [[complexity-preservation]].

## Связи

- [[archetypes]] — example_of
- [[research]] — related_to
- [[world-model]] — produces
- [[complexity-preservation]] — risk

## Следующие действия

- **Посмотреть картину мира** → [[world-model]]: Поможет понять, какую систему объяснений человек уже использует.
- **Увидеть риск сложности** → [[complexity-preservation]]: Поможет отличить исследование от удерживания лишней сложности.
- **Перейти к исследованиям** → [[research]]: Поможет продолжить путь через авторские наблюдения и принципы.
