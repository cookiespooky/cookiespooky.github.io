...
links:
  ...
  - id: "funnel"
    rel: "compatible_with"
actions:
  - label: "Понять Recca-сценарий"
    target: "partner-network"
    help: "Поможет увидеть Recca как сеть витрин, офферов и партнерских переходов."
  - label: "Собрать партнерскую витрину"
    target: "lead-recca-network"
    help: "Поможет определить офферы, участников, реферальную механику и первый маршрут заявок."
  - label: "Связать с Marketing OS"
    target: "marketing-os"
    help: "Поможет сначала уточнить позиционирование и логику офферов, если витрина еще не готова."
seo:
  title: "Recca"
  description: "Recca — продуктовая среда для витрин, экспертных офферов, партнерских сетей и реферальных механик. Она помогает собрать предложения, участников и маршруты заявок в одну связанную систему."
---
