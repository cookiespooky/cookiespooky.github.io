...
Связанные элементы: [[archetypes]], [[personal-myth]], [[narrative-positioning]], [[cognitive-reconstruction]].

## Связи

- [[archetypes]] — uses
- [[personal-myth]] — uses
- [[narrative-positioning]] — leads_to
- [[cognitive-reconstruction]] — compatible_with

## Следующие действия

- **Начать с личного мифа** → [[personal-myth]]: Поможет собрать основной сюжет и роли.
- **Связать с позиционированием** → [[narrative-positioning]]: Поможет превратить сюжет в понятное описание для аудитории.
- **Разобрать ситуацию глубже** → [[cognitive-reconstruction]]: Поможет связать архетипический слой с картой фактов, решений и действий.
